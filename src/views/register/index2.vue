<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-row>
          <el-col :span="16">
              <el-form-item prop="verificationCode"><!--class="verificationCodeInput"-->
                  <span class="svg-container">
                      <svg-icon icon-class="user"/>
                  </span>
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleLogin">注册</el-button><!--.native.prevent-->
...
export default {
  ...
  methods: {
    /*  judge whether  CapsLocks is open*/
